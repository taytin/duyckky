...
function simple_ajax_chat_wp_resources() {
	...
	<div id="project-wrap">
		...
		<div class="project-blurb">
			...
			<p><?php echo $donate; ?></p>
			<ul>
				<li><a target="_blank" rel="noopener noreferrer" href="https://monzillamedia.com/donate.html" title="<?php echo $title3; ?>"><?php esc_html_e('Make a donation&nbsp;&raquo;', 'simple-ajax-chat'); ?></a></li>
			</ul>
		</div>
	</div>
